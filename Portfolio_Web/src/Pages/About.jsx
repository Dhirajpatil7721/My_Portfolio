  ...
  return (
    <section id="about" className="bg-white text-gray-900 py-12 px-4  mt-10   sm:px-6 lg:px-12">
      <div className="container mx-auto text-center">
        ...
        >
          I am <span className="text-blue-500 font-semibold">Dhiraj Patil</span>, a passionate <span className="text-blue-600">Full-Stack Developer</span> dedicated to exploring
