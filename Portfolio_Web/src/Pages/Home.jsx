        ...
        >
          <div className="max-w-4xl space-y-6">
            <motion.h1
              ...
              transition={{ duration: 0.8 }}
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500"
            >
              Dhiraj Patil
            </motion.h1>
            <motion.h2
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-6 lg:gap-10">
          ...
          >
            ...
            <div className="z-10 mt-4 sm:mt-6 px-4 sm:px-6 space-y-2">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-800">Dhiraj Patil</h3>
          ...
          >
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap gap-2">
              {['JavaScript', 'React', 'Java', 'Spring Boot', 'MongoDB', 'AWS', 'Docker'].map((skill) => (
                <motion.span
                  key={skill}
